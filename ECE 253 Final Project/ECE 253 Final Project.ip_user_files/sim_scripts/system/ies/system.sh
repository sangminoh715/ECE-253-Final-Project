...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ECE 253 Final Project.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../ECE 253 Final Project.srcs/sources_1/bd/system/ipshared/ec67/hdl"
}
