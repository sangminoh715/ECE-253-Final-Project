...
HD_PWD='D:/Xilinx/Projects/ECE-253-Final-Project/Qwop/Qwop.runs/system_axi_tft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_tft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_tft_0_0.tcl
